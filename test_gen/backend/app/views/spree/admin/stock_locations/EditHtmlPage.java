...
public class EditHtmlPage extends AbstractPage {
  ...
  @FindBy(how = How.XPATH, using = "//*[@id='__pogen_618']")
  ...
  public String getTextOfLink_to_with_icon__icon_minus_arrow_minus_left___Spree_dot_t__back_to_stock_locations_list___admin_stock_locations_path___class_____button__() {
    ...
    while (matcher.find()) {
      if (matcher.group(1).equals("__pogen_618") && matcher.group(2).equals("link_to_with_icon__icon_minus_arrow_minus_left___Spree_dot_t__back_to_stock_locations_list___admin_stock_locations_path___class_____button__")) {
  ...
  @FindBy(how = How.XPATH, using = "//*[@id='__pogen_619']")
  ...
  public String getTextOfRender__partial_____form____locals_______f____f___() {
    Matcher matcher = commentPattern.matcher(driver.getPageSource());
    while (matcher.find()) {
      if (matcher.group(1).equals("__pogen_619") && matcher.group(2).equals("render__partial_____form____locals_______f____f___")) {
        return matcher.group(3);
      }
    }
    return null;
  ...
  public String getTextOfRender__partial_____spree_divide_admin_divide_shared_divide_edit_resource_links__() {
    Matcher matcher = commentPattern.matcher(driver.getPageSource());
    while (matcher.find()) {
      if (matcher.group(1).equals("__pogen_619") && matcher.group(2).equals("render__partial_____spree_divide_admin_divide_shared_divide_edit_resource_links__")) {
        return matcher.group(3);
      }
    }
    return null;
