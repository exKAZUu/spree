...
public class EditHtmlPage extends AbstractPage {
  ...
  @FindBy(how = How.XPATH, using = "//*[@id='__pogen_633']")
  ...
  public String getTextOfLink_to_with_icon__icon_minus_arrow_minus_left___Spree_dot_t__back_to_stock_movements_list___admin_stock_location_stock_movements_path_stock_location____class_____button__() {
    ...
    while (matcher.find()) {
      if (matcher.group(1).equals("__pogen_633") && matcher.group(2).equals("link_to_with_icon__icon_minus_arrow_minus_left___Spree_dot_t__back_to_stock_movements_list___admin_stock_location_stock_movements_path_stock_location____class_____button__")) {
  ...
  @FindBy(how = How.XPATH, using = "//*[@id='__pogen_634']")
  ...
  public String getTextOfRender__partial_____spree_divide_admin_divide_shared_divide_new_resource_links___locals____collection_url__admin_stock_location_stock_movements_path_stock_location____() {
    Matcher matcher = commentPattern.matcher(driver.getPageSource());
    while (matcher.find()) {
      if (matcher.group(1).equals("__pogen_634") && matcher.group(2).equals("render__partial_____spree_divide_admin_divide_shared_divide_new_resource_links___locals____collection_url__admin_stock_location_stock_movements_path_stock_location____")) {
        return matcher.group(3);
      }
    }
    return null;
  ...
  public String getTextOfRender__partial_____form____locals_______f____f___() {
    Matcher matcher = commentPattern.matcher(driver.getPageSource());
    while (matcher.find()) {
      if (matcher.group(1).equals("__pogen_634") && matcher.group(2).equals("render__partial_____form____locals_______f____f___")) {
        return matcher.group(3);
      }
    }
    return null;
