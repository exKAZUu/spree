...
public class FormHtmlPage extends AbstractPage {
  ...
  @FindBy(how = How.XPATH, using = "//*[@id='__pogen_414']")
  ...
  public String getTextOfF_dot_text_field__name___class_____fullwidth__() {
    ...
    while (matcher.find()) {
      if (matcher.group(1).equals("__pogen_414") && matcher.group(2).equals("f_dot_text_field__name___class_____fullwidth__")) {
  ...
  public String getTextOfF_dot_error_message_on__name_() {
    Matcher matcher = commentPattern.matcher(driver.getPageSource());
    while (matcher.find()) {
      if (matcher.group(1).equals("__pogen_414") && matcher.group(2).equals("f_dot_error_message_on__name_")) {
        return matcher.group(3);
      }
    }
    return null;
  ...
  public String getTextOfF_dot_label__name__Spree_dot_t__name__() {
    Matcher matcher = commentPattern.matcher(driver.getPageSource());
    while (matcher.find()) {
      if (matcher.group(1).equals("__pogen_414") && matcher.group(2).equals("f_dot_label__name__Spree_dot_t__name__")) {
        return matcher.group(3);
      }
    }
    return null;
  ...
  public String getTextOfF_dot_field_container__name_do_() {
    Matcher matcher = commentPattern.matcher(driver.getPageSource());
    while (matcher.find()) {
      if (matcher.group(1).equals("__pogen_414") && matcher.group(2).equals("f_dot_field_container__name_do_")) {
        return matcher.group(3);
      }
    }
    return null;
  ...
  @FindBy(how = How.XPATH, using = "//*[@id='__pogen_415']")
  ...
  public String getTextOfF_dot_error_message_on__presentation_() {
    Matcher matcher = commentPattern.matcher(driver.getPageSource());
    while (matcher.find()) {
      if (matcher.group(1).equals("__pogen_415") && matcher.group(2).equals("f_dot_error_message_on__presentation_")) {
        return matcher.group(3);
      }
    }
    return null;
  ...
  public String getTextOfF_dot_label__presentation__Spree_dot_t__presentation__() {
    Matcher matcher = commentPattern.matcher(driver.getPageSource());
    while (matcher.find()) {
      if (matcher.group(1).equals("__pogen_415") && matcher.group(2).equals("f_dot_label__presentation__Spree_dot_t__presentation__")) {
        return matcher.group(3);
      }
    }
    return null;
  ...
  public String getTextOfF_dot_field_container__presentation_do_() {
    Matcher matcher = commentPattern.matcher(driver.getPageSource());
    while (matcher.find()) {
      if (matcher.group(1).equals("__pogen_415") && matcher.group(2).equals("f_dot_field_container__presentation_do_")) {
        return matcher.group(3);
      }
    }
    return null;
  ...
  public String getTextOfF_dot_text_field__presentation___class_____fullwidth__() {
    Matcher matcher = commentPattern.matcher(driver.getPageSource());
    while (matcher.find()) {
      if (matcher.group(1).equals("__pogen_415") && matcher.group(2).equals("f_dot_text_field__presentation___class_____fullwidth__")) {
        return matcher.group(3);
      }
    }
    return null;
