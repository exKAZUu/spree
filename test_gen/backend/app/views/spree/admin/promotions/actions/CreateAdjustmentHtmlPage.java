...
public class CreateAdjustmentHtmlPage extends AbstractPage {
  public CreateAdjustmentHtmlPage(WebDriver driver) {
    super(driver);
    assertInvariant();
  }
  ...
  @FindBy(how = How.XPATH, using = "//*[@id='__pogen_378']")
  ...
  public String getTextOfSpree_dot_t__calculator_settings_warning__() {
    ...
    while (matcher.find()) {
      if (matcher.group(1).equals("__pogen_378") && matcher.group(2).equals("Spree_dot_t__calculator_settings_warning__")) {
  ...
  @FindBy(how = How.XPATH, using = "//*[@id='__pogen_377']")
  ...
  public String getTextOfLabel_tag_field_name__Spree_dot_t__calculator__() {
    Matcher matcher = commentPattern.matcher(driver.getPageSource());
    while (matcher.find()) {
      if (matcher.group(1).equals("__pogen_377") && matcher.group(2).equals("label_tag_field_name__Spree_dot_t__calculator__")) {
        return matcher.group(3);
      }
    }
    return null;
  ...
  @FindBy(how = How.XPATH, using = "//*[@id='__pogen_379']")
  ...
  public String getTextOfLabel_tag_field_name__Spree_dot_t_key_dot_to_s__() {
    Matcher matcher = commentPattern.matcher(driver.getPageSource());
    while (matcher.find()) {
      if (matcher.group(1).equals("__pogen_379") && matcher.group(2).equals("label_tag_field_name__Spree_dot_t_key_dot_to_s__")) {
        return matcher.group(3);
      }
    }
    return null;
  ...
  public String getTextOfHidden_field_tag____param_prefix__calculator_attributes__id____promotion_action_dot_calculator_dot_id_() {
    Matcher matcher = commentPattern.matcher(driver.getPageSource());
    while (matcher.find()) {
      if (matcher.group(1).equals("__pogen_379") && matcher.group(2).equals("hidden_field_tag____param_prefix__calculator_attributes__id____promotion_action_dot_calculator_dot_id_")) {
        return matcher.group(3);
      }
    }
    return null;
